...
public class Covid_Data_Activity_v2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Future<JSONObject> all = es.submit(new Callable<JSONObject>() {
            public JSONObject call() throws Exception {
                JSONObject object = get_json_from_world();
                return object;
    ...
    private void edit_dialog(JSONObject object) {
        ...
        try {
            ...
            String dialog_affected = formatter.format(object.getDouble("affectedCountries"));
            Dialog dialog = new Dialog(Covid_Data_Activity_v2.this);
            ...
            dialog_affected_textview = dialog.findViewById(R.id.dialog_affected);
            ...
            dialog_affected_textview.setText("Affected Countries: " + dialog_affected);
            dialog.show();
        } catch (JSONException e) {
            e.printStackTrace();
        }
